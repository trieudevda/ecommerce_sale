...
const Page = () => {
    ...
    // Component Custom nhập giá tiền
    ...
    return (
        ...
        >
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-sm mt-1">
                                Chỉnh sửa thông tin chi tiết cho sản phẩm đang chọn.
                            </p>
                        </div>
                    </div>
                    ...
                    <Spin spinning={isLoading}>
                        ...
                        >
                            <div className="flex flex-col lg:flex-row gap-6">
                                ...
                                <div className="flex-1 flex flex-col gap-6">
                                    ...
                                    <Card variant="borderless" className="rounded-[24px] shadow-sm ring-1 ring-slate-900/5 bg-white">
                                        <div className="flex items-center gap-2 mb-6 text-slate-800 font-semibold text-lg">
                                            <EditOutlined className="text-blue-500" /> Thông tin cơ bản
                                        </div>
                                                        ...
                                                        <div key={key} className="relative p-5 rounded-2xl bg-slate-50 border border-slate-100 transition-all hover:border-blue-100 group">
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-2">
                                                                <Form.Item
                                                                    ...
                                                                    label={<span className="text-slate-600 font-medium text-sm">{t('attribute') || 'Thuộc tính'}</span>}
                                                                ...
                                                                <Form.Item
                                                                    ...
                                                                    rules={[{ required: true, message: t('enter_inventory') || 'Nhập tồn kho' }]}
                                                                    className="mb-0"
                                                                >
                                ...
                                {/* ---------------- CỘT PHẢI (DANH MỤC & MEDIA) ---------------- */}
                                <div className="w-full lg:w-[360px] flex flex-col gap-6 shrink-0">

                                    {/* PHÂN LOẠI */}
                                    <Card variant="borderless" className="rounded-[24px] shadow-sm ring-1 ring-slate-900/5 bg-white">
                                        <div className="flex items-center gap-2 mb-6 text-slate-800 font-semibold text-lg">
                                            <InboxOutlined className="text-blue-500" /> Phân loại
                                        </div>
                                    ...
                                    <Card variant="borderless" className="rounded-[24px] shadow-sm ring-1 ring-slate-900/5 bg-white">
                                        <div className="flex items-center gap-2 mb-6 text-slate-800 font-semibold text-lg">
                                            <PictureOutlined className="text-blue-500" /> Hình ảnh sản phẩm
                                        </div>

                                        {/* Ảnh đại diện */}
                                        <Form.Item label={<span className="text-slate-600 font-medium">{t("avatar")} (Ảnh chính)</span>}>
                                            <Upload
                                            ...
                                            >
                                                {!avatarFile && !avatarPreview && (
                                                    <div className="flex flex-col items-center justify-center text-slate-500 p-4">
                                                        ...
                                                        <div className="text-sm font-medium">Tải lên ảnh nền</div>
                                                    </div>
                                                )}
                                            </Upload>
                                        </Form.Item>
                                        ...
                                        {/* Thư viện ảnh */}
                                        <Form.Item
                                            label={<span className="text-slate-600 font-medium">{t("gallery")} (Ảnh chi tiết)</span>}
                                            className="mb-0"
                                        >
                                            <Upload
                                                listType="picture-card"
            ...
            {/* CSS Tùy chỉnh cho Upload Ảnh Đại Diện */}
