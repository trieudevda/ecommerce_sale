            ...
            try {
                ...
                if (res && !res.statusCode) {
                    ...
                    messageApi.error({
                        ...
                        description: res.message || tMess('Description.no_role_found')
                    });
                }
            } catch (error) {
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            <Typography.Title level={2} className="!mb-0 !text-2xl !font-extrabold tracking-tight text-slate-800">
                                {t("edit") || "Chỉnh sửa vai trò"}
                            </Typography.Title>
                            <p className="text-slate-500 text-sm mt-1">
                                {t('update_the_configuration_information_for_this_role')}
                            </p>
                        </div>
                    </div>
                        ...
                        <Spin spinning={isLoading}>
                            ...
                            >
                                <div className="flex items-center gap-2 mb-6 text-slate-800 font-semibold text-lg">
                                    <SafetyCertificateOutlined className="text-blue-500" /> Thông tin vai trò
                                </div>
