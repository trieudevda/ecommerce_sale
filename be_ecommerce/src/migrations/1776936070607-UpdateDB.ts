...
export class UpdateDB1776936070607 implements MigrationInterface {
    name = 'UpdateDB1776936070607'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`short_description\` text NULL`);
